...
# def create_base_cnn_model(input_shape, hidden_size: int = 128, dropout: float = 0.05):
#     input = Input(shape=input_shape)
#     x = Conv2D(32, kernel_size=(3, 3), activation='relu', input_shape=input_shape, padding = 'same')(input)
...
#
#     x = Flatten()(x)
#     x = Dense(hidden_size, activation='relu', name='project_1')(x)
#     x = BatchNormalization()(x)
#     x = Dropout(dropout)(x)
#     x = Dense(hidden_size, activation='relu', name='project_2')(x)
#     x = BatchNormalization()(x)
#     x = Dropout(dropout)(x)
#     output = Dense(hidden_size, activation='relu', name='project_3')(x)
#
